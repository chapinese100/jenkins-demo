    ...
    stages {
        stage('Clone') {
            steps {
                ...
                git 'https://github.com/chapinese100/jenkins-demo.git'
        ...
        stage("Metrics"){
         ...
         post{
                success {
                    emailext body: 'Successfully completed pipeline project with archiving the artifacts', subject: 'Pipeline was successfull', to: 'ivan.gutierrez0908@gmail.com'
                }
    }
}
